...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None):
        ...
        # To run on Apple Sillicon, device="cpu" is the only option available (faster-whisper supports only cpu or cuda)
...
# self.silence_iters = 0
    ...
    def words_to_sentences(self, words):
        ...
        # The error was here s = self.tokenizer.split(t) split is not a method of tokenizer.
        # Here you can check how to use it: https://github.com/luismsgomes/mosestokenizer
        s = self.tokenizer(t)
        out = []
        while s:
            beg = None
